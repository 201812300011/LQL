...
// 第14周学生信息管理系统Set.cpp : C第14周学生信息管理系统Set 类的实现
//
...
// 代码生成在 2020年6月22日, 16:16

IMPLEMENT_DYNAMIC(C第14周学生信息管理系统Set, CRecordset)

C第14周学生信息管理系统Set::C第14周学生信息管理系统Set(CDatabase* pdb)
	: CRecordset(pdb)
{
	m_ID = 0;
	m_1 = L"";
...
// 储为其他格式或使用其他的用户身份验证。
CString C第14周学生信息管理系统Set::GetDefaultConnect()
{
...
CString C第14周学生信息管理系统Set::GetDefaultSQL()
{
	return _T("[学生信息管理系统]");
}

void C第14周学生信息管理系统Set::DoFieldExchange(CFieldExchange* pFX)
{
...
#ifdef _DEBUG
void C第14周学生信息管理系统Set::AssertValid() const
{
	CRecordset::AssertValid();
}

void C第14周学生信息管理系统Set::Dump(CDumpContext& dc) const
{
	CRecordset::Dump(dc);
}
#endif //_DEBUG
