...
// MFC2020.03.10.test3Doc.cpp : CMFC20200310test3Doc 类的实现
//
...
CMFC20200310test3Doc::CMFC20200310test3Doc()
{
	...
	rect1.left = 50; rect1.top = 75; rect1.right = 70; rect1.bottom = 100;//矩形左上角和右下角坐标位置
