...
// 2020.03.17.example7Doc.cpp : CMy20200317example7Doc 类的实现
//
...
CMy20200317example7Doc::CMy20200317example7Doc()
{
	...
	for (int i = 0; i < N; i++)
	{
		int t = (i + 1) * 100;//矩形左上角横坐标位置t
		CRect rect(t,0,t+20,20);//设置矩形边长为20，上边缘与客户区上边缘重合
		cr.Add(rect);//提交矩形
	}
}
